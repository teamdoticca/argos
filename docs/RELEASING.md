...
Read-only inspection on 2026-09-18 found a private repository, unprotected master, disabled secret scanning/push protection and disabled Dependabot security updates. These settings were not changed by local preparation. Cross-platform GitHub workflow execution, protected environments, registry trust policies and anonymous access must be verified by the maintainer before launch.
